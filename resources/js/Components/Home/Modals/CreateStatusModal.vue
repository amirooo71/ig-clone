...
<template>
    <div class="hidden lg:p-20" id="create-status" uk-modal="">
        ...
        >
            <div
                class="text-center py-3 border-b -m-7 mb-0 dark:border-slate-700"
            >
                ...
                <button
                    type="button"
                    class="button__ico absolute top-0 right-0 m-2.5 uk-modal-close"
                >
                    <svg
            ...
            <div class="space-y-5 mt-7">
                ...
                <div>
                    <div
                        class="w-full h-72 relative border1 rounded-lg overflow-hidden bg-[url('https://demo.foxthemes.net/images/ad_pattern.png')] bg-repeat"
                    >
                        <label
                            for="createStatusUrl"
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-start gap-2">
                        ...
                        <p class="text-sm text-gray-500 font-medium">
                            ...
                            for <span class="text-gray-800"> 24 Hours</span>
                        </p>
                    </div>

                    <button
                        type="button"
                        class="button bg-blue-500 text-white px-8"
                    >
                        Create
                    </button>
                </div>
